...
class SpotInstance
{
    ...
    # accessors
    public function getSpotInstanceId() { return $this->m_spot_id; }
    public function getEc2InstanceId()  { return $this->m_ec2_instance_id; }
    public function getDeploymentTime() { return $this->m_create_time; }
