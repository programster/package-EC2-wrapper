...
class RequestDescribeSpotInstances extends AbstractEc2Request
{
     ...
     */
    public function __construct(\Programster\Ec2Wrapper\Enums\AwsRegion $region, $spot_instance_id=array())
    {
     ...
     */
    public function setFilter(\Programster\Ec2Wrapper\Objects\AmazonFilter $filter)
    {
